        ...
        children: [
          ...
          Positioned.fill(
            child: !isGoogleMapsInitialized()
                ...
                // Animate camera target smoothly with moving marker
                ...
                // Pickup/Destination coordinate mocks
                final pickupPos = LatLng(position.latitude + 0.005, position.longitude + 0.005);
                final destPos = LatLng(position.latitude - 0.005, position.longitude - 0.005);
                ...
                return GoogleMap(
                  ...
                  markers: {
                    ...
                    Marker(
                      ...
                      infoWindow: const InfoWindow(title: "Pickup: Ramapuram Market"),
                    ),
                    Marker(
                      markerId: const MarkerId("dest"),
                      position: destPos,
                      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
                      infoWindow: const InfoWindow(title: "Destination: Anantapur Bus Stand"),
                    ),
                  },
                  polylines: {
                    Polyline(
              ...
              error: (err, stack) => const Center(
                child: Text("Error loading real GPS maps"),
              ),
